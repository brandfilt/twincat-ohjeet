...
Sovelluksen oikeaan reunaan avautuu *ToolBox*, jonka alta LD-ohjelmointiin
käytettävät työkalut löytyvät. LD-komponentteja voidaan lisätä ohjelmaan
raahaamalla niitä *ToolBox*-ikkunasta, ja tiputtamalla ne sopivaan kohtaan ohjelmassa.
...
vieressä olevaan pieneen laatikkoon, tai tuplaklikkaamalla laatikkoja, jolloin
muuttujan voi valita listasta. Glob
